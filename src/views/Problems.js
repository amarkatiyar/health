...
export default class Symtom extends React.Component{
  ...
  handleShowProblemsCodeForm=() => {
    this.props. handleHideProblemsCodeForm();
}
render(){
...
<Card  style={{height:"500px",width:"600px"}}>
    ...
    <div className="row" >
    <div onClick ={()=>this.handleShowProblemsCodeForm()} className="ml-3"> <i className="fas fa-arrow-left"></i>&nbsp;
     Favourite Problems</div>
    </div>
    </CardHeader>
    ...
    <div className="row">
        ...
        <div className="col-sm-1"><span className=" hover icon-md fas fa-ellipsis-v"style={{cursor:"pointer"}}></span></div>
            ...
            <div className="row mt-4">
                ...
                <small><b>There are no favorite set, add your favorite and use them quickly in EHR</b></small>
                </div>
            </div>
</Card>
)
